...
function consPicCont(nickname, sharp, typecode, typename, fwitdh) {
    ...
    //		return recon;
    var str4 = "<div id='uploader" + typecode + "'></div> <div class='choose-file-btn' id='choose_file_" + typecode + "'>选择图片</div> <button type='button' id='upload_now" + typecode + "'>上传图片</button>";
